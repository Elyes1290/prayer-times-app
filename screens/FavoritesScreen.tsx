...
const FavoritesScreen: React.FC = () => {
  ...
  const filterOptions: Array<{
    ...
    {
      key: "all",
      label: t("favorites.all") || "Tous",
      icon: "heart-multiple",
      count: favorites.length,
    },
    {
      key: "quran_verse",
      label: t("favorites.quran") || "Coran",
      icon: "book-open-variant",
      count: getFavoritesCountByType("quran_verse"),
    },
    {
      key: "hadith",
      label: t("favorites.hadith") || "Hadiths",
      icon: "book",
      count: getFavoritesCountByType("hadith"),
    },
    {
      key: "dhikr",
      label: t("favorites.dhikr") || "Dhikr",
      icon: "hand-heart",
      count: getFavoritesCountByType("dhikr"),
    },
    {
      key: "asmaul_husna",
      label: t("favorites.names") || "Noms d'Allah",
      icon: "star-circle",
  ...
  const handleRemoveFavorite = (favorite: Favorite) => {
    Alert.alert(
      t("favorites.remove_title") || "Retirer des favoris",
  ...
  const handleClearAll = () => {
    ...
    Alert.alert(
      t("favorites.clear_all_title") || "Vider les favoris",
      t("favorites.clear_all_confirm") ||
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyContainer}>
      ...
      <Text style={styles.emptyTitle}>
        {selectedFilter === "all"
          ? t("favorites.empty_all") || "Aucun favori"
          : t("favorites.empty_filter") || "Aucun favori dans cette catégorie"}
      </Text>
